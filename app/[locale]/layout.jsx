        ...
        <Script id="tiktok-pixel" strategy="lazyOnload">
          {`
            !function (w, d, t) {
              ...
              ttq.load('CTKNGU3C77UF7KOQAJSG');
              ttq.page();
            }(window, document, 'ttq');
          `}
        </Script>

        {/* TikTok event bridge — maps GA4 dataLayer events to ttq */}
              ...
              window.dataLayer.push = function(){
                ...
                if(eventObj && eventObj.event){
                  ...
                  switch(eventObj.event){
                    ...
                    case "search":
                    window.ttq?.track("Search", { contents: items.map(i => ({ content_id: i.item_id || "search", content_type: "product", content_name: i.item_name || (eventObj.search_term || "search") })), value: ecommerce.value || 0, currency: ecommerce.currency || "KWD", search_string: eventObj.search_term || "" }); break;
                  }
                }
              };
            })();
