...
const ProductSchema = ({ category, subcategory, product }) => {
  ...
  const jsonLd = {
      ...
      offers: {
          ...
          priceCurrency: "KWD",
          price: product.price,
          url: `https://kw.ahmedalmaghribi.com/en/shop/${category}/${subcategory}/${product.product_name
              .split(" ")
              .join("-")
              .toLowerCase()}`,
          availability:
  ...
  try {
    ...
    return (
      ...
      <Head>
                    ...
                    <meta
                        property="og:url"
                        content={`https://kw.ahmedalmaghribi.com/en/shop/${categoryName}/${subCategoryName}/${data.product_name
                            .split(" ")
                            .join("-")
                            .toLowerCase()}`}
                    />
                    ...
                    <meta
                        ...
                        content="Ahmed Al Maghribi Perfumes Kuwait"
                    />
                </Head>
        <Header14 />
        <ProductSchema
